...
class MarketScanner {
   ...
   * Format: "precipitation-in-{city}-in-{month}"
   */
  ...
  async getActivePrecipitationMarkets() {
    try {
      ...
      this.log('info', `Found ${found} precipitation markets (${notFound} slugs not found)`);
...
module.exports = { MarketScanner, WEATHER_CITIES, PRECIPITATION_CITIES };
