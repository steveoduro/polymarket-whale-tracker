...
class MispricingDetector {
  ...
  analyzeMarket(market, forecast) {
    ...
    return {
      ...
      // Risk management fields (use normalized price for edge calculation)
      marketProbability: marketProbability, // normalized price
  ...
  generatePositions(opportunity, capital, config = {}) {
    ...
    // Use normalized price for Kelly calculation (edge analysis)
    const marketProbability = opportunity.marketProbability || range.normalizedPrice || range.price;
