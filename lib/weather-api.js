...
// Updated: 2026-02-06 based on 56 resolved trades
const CITY_SOURCE_PRIORITY = {
  // US Cities - NWS available
  'dallas': ['nws', 'weatherapi', 'openmeteo'],        // NWS: 0.2°F vs OM: 2.9°F
  'seattle': ['nws', 'weatherapi', 'openmeteo'],          // NWS: 1.0°F vs WA: 1.15°F
  'chicago': ['openmeteo', 'nws', 'weatherapi'],          // OM: 0.54°F vs NWS: 1.4°F
  'miami': ['openmeteo', 'nws', 'weatherapi'],          // OM: 1.6°F best
  'atlanta': ['openmeteo', 'nws', 'weatherapi'],        // OM: 1.4°F (only source with data)
  'denver': ['openmeteo', 'nws', 'weatherapi'],         // OM: 1.4°F (only source with data)
  'nyc': ['openmeteo', 'nws', 'weatherapi'],            // OM: 2.0°F (limited data)
  'los angeles': ['openmeteo', 'nws', 'weatherapi'],    // OM: 0.5°F
  'san francisco': ['openmeteo', 'nws', 'weatherapi'],  // OM: 2.8°F (limited data)
  'austin': ['nws', 'openmeteo', 'weatherapi'],           // NWS: 1.6°F vs OM: 1.8°F
  'las vegas': ['openmeteo', 'nws', 'weatherapi'],      // OM: 0.2°F
  'new orleans': ['nws', 'openmeteo', 'weatherapi'],      // NWS: 0.6°F vs OM: 1.25°F
  'philadelphia': ['openmeteo', 'nws', 'weatherapi'],   // OM: 4.2°F (limited data)
  'houston': ['nws', 'openmeteo', 'weatherapi'],        // Assume NWS good for TX
  'dc': ['nws', 'openmeteo', 'weatherapi'],             // Assume NWS good for east coast
  // International Cities - No NWS
  'toronto': ['weatherapi', 'openmeteo'],               // WA: 0.4°F vs OM: 1.1°F
  'london': ['openmeteo', 'weatherapi'],                  // OM: 0.95°F vs WA: 1.3°F
  'seoul': ['weatherapi', 'openmeteo'],                  // WA: 0.9°F vs OM: 1.1°F
  'wellington': ['weatherapi', 'openmeteo'],             // WA: 0.1°F vs OM: 0.5°F
  'ankara': ['openmeteo', 'weatherapi'],                 // OM: 0.8°F vs WA: 1.5°F
  'buenos aires': ['weatherapi', 'openmeteo'],             // WA: 3.4°F vs OM: 4.84°F
};
...
class WeatherAPI {
  ...
  async getMultiSourceForecast(cityName, targetDate) {
    ...
    return {
      ...
      // Select best source based on city-specific priority
      ...this.selectBestForecast(city.key, forecasts, avgTempF),
      preferredUnit: city.unit,
