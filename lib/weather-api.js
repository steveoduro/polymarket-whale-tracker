...
const CITY_SOURCE_PRIORITY = {
  ...
  'seattle': ['weatherapi', 'nws', 'openmeteo'],        // WA: 1.4°F vs OM: 3.0°F
  'chicago': ['nws', 'openmeteo', 'weatherapi'],        // NWS/OM tied at 0.4°F
  ...
  'austin': ['openmeteo', 'nws', 'weatherapi'],         // OM: 2.5°F (limited data)
  'las vegas': ['openmeteo', 'nws', 'weatherapi'],      // OM: 0.2°F
  'new orleans': ['openmeteo', 'nws', 'weatherapi'],    // OM: 0.7°F
  ...
  'london': ['weatherapi', 'openmeteo'],                // WA: 0.8°F vs OM: 1.1°F
  ...
  'buenos aires': ['openmeteo', 'weatherapi'],           // OM: 5.6°F vs WA: 6.0°F
};
